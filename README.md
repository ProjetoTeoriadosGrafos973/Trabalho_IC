...
Documento referente ao planejamento, execução das buscas, triagem e seleção dos artigos utilizados no levantamento bibliográfico.

**Tema delimitado:** Complexidade e eficiência energética de algoritmos de alocação de máquinas virtuais em data centers.
